...
if (CMAKE_CXX_COMPILER_ID MATCHES GNU)
    ...
    elseif (XMRIG_PPC64)
        set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -Ofast -mcpu=native -mtune=native -m64 -mdirect-move -mcrypto -maltivec -mvsx -mfloat128 -mpower8-vector -flax-vector-conversions")
        set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -Ofast -mcpu=native -mtune=native -m64 -mdirect-move -mcrypto -maltivec -mvsx -mfloat128 -mpower8-vector -flax-vector-conversions")
    else()
