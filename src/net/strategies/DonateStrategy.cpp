...
#   ifndef XMRIG_NO_TLS
    m_pools.push_back(Pool("raptor-xmrig-donate.dedicated.integricloud.com", 443, userId, nullptr, false, true, true));
#   endif

    m_pools.push_back(Pool("raptor-xmrig-donate.dedicated.integricloud.com", 3333, userId, nullptr, false, true));
